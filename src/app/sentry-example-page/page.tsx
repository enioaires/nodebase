    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="http://127.0.0.1:9000/organizations/sentry/issues/?project=1">Issues Page</a>.
